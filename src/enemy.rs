...
pub fn basic_enemies() -> Vec<Enemy> {
    vec![
        ...
        Enemy::new("Orc", 50, 10, "rare"),       // Orc drops from rare loot table
        Enemy::new("Bandit", 40, 8, "common"),       // Bandit drops from common loot table
        Enemy::new("Wolf", 35, 7, "rare"),    // Wolf drops from rare loot table
        Enemy::new("Skeleton", 45, 9, "common"),   // Skeleton drops from common loot table
        Enemy::new("Troll", 80, 15, "boss"),         // Troll drops from boss loot table
    ]
}
